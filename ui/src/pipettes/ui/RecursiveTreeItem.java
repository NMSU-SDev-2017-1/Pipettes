// RecursiveTreeItem
// free implementation from Manuel Mauky's Blog:
// http://lestard.eu/2015/treetable_datamodel/
...
public class RecursiveTreeItem<T> extends TreeItem<T>
{
  ...
  public RecursiveTreeItem(final T value,
        ...
        if (change.wasAdded())
        {
          change.getAddedSubList().forEach(
              t -> RecursiveTreeItem.this.getChildren().add(
                  new RecursiveTreeItem<>(t, this.graphicsFactory,
                      childrenFactory)));
        }
